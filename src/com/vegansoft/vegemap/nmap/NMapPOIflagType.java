...
public class NMapPOIflagType {
	...
	public static final int PIN_GREEN_MILKY = 2;
	public static final int PIN_GREEN_YELLOW = 3;
	public static final int PIN_GREEN_YELLOW_MILKY = 4;
	public static final int PIN_MOSTLY = 5;
	public static final int PIN_PARTLY = 6;
